<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
        <h3 class="sidebar-brand brand-logo text-white">One Click Health</h3>
        <a class="sidebar-brand brand-logo-mini"><img src="dashboard/assets/images/logo-mini.svg" alt="logo" /></a>
    </div>
    <ul class="nav">
        ...
        <li class="nav-item menu-items">
            <a class="nav-link" href="/showinsurance">
                <span class="menu-icon">
                    <i class="mdi mdi-file-document-box"></i>
                </span>
                <span class="menu-title">Show Insurance</span>
            </a>
        </li>
    </ul>
</nav>